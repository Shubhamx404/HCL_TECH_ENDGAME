...
with st.sidebar:
    ...
    with st.expander("⚙️ Vector DB Settings", expanded=False):
    ...
    if not st.session_state.document_processed:
        with st.spinner("🔍 Processing documents and building vector database..."):
            ...
            if st.session_state.data_source == "files":
                ...
                with st.status("Processing URL content...") as status:
                    ...
                    if raw_text:
                        ...
                        status.update(label="⚠️ Could not process URL content", state="error")
            ...
            if raw_text:
                ...
                with st.status("🗄️ Building FAISS vector database...", expanded=False) as status:
            ...
            <div class='card'>
                ...
                <div style='margin: 2rem 0;'>
                    <div style='display: flex; align-items: center; margin: 1rem 0;'>
                        <span style='background: #fce7f3; padding: 0.5rem; border-radius: 50%; margin-right: 1rem;'>🗄️</span>
                        <div>
